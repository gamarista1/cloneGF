      ...
      <div className="container-page relative py-20">
        <div className="grid gap-12 lg:grid-cols-[1.4fr_1fr_1fr_1fr_1.1fr]">
          <div>
            ...
            <p className="mt-8 text-xs text-white/50">© {new Date().getFullYear()} Grupo Sife. Todos los derechos reservados.</p>
          </div>
          {cols.map((c) => (
            <div key={c.heading}>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-white/70">
              <li className="flex items-start gap-2"><Mail className="h-4 w-4 shrink-0 mt-0.5" />info@gruposife.com</li>
              <li className="flex items-start gap-2"><MapPin className="h-4 w-4 shrink-0 mt-0.5" />Caracas, Venezuela</li>
            </ul>
