      ...
      <div className="flex flex-wrap gap-3 mb-12 justify-center">
        {items.map((t) => (
          <button
            ...
            className={`rounded-full px-6 py-3 text-sm font-bold tracking-wide transition-all duration-300 ${active === t.key ? "bg-[var(--brand)] text-white shadow-lg shadow-[var(--brand)]/20" : inactiveCls
              }`}
          >
            {t.label}
          </button>
